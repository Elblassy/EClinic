...
public class MyoldAppointmentAdapter extends RecyclerView.Adapter<MyoldAppointmentAdapter.ViewHolder> {
    ...
    public MyoldAppointmentAdapter(Context context, CustomClickListener clickListener) {
    ...
    @NonNull
    @Override
    public MyoldAppointmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_appointment_list_item, parent,
                false);
        return new MyoldAppointmentAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyoldAppointmentAdapter.ViewHolder holder, int position) {
